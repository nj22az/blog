...
import {
  ...
  motion,
  useMotionValue
} from "./chunk-D4EYGREY.js";
import "./chunk-A7II7DSL.js";
...
// node_modules/sanity-plugin-hotspot-array/dist/index.mjs
...
function Feedback({ children }) {
  return (0, import_jsx_runtime.jsx)(Card, { padding: 4, radius: 2, shadow: 1, tone: "caution", children: (0, import_jsx_runtime.jsx)(Text, { children }) });
}
var dragStyle = {
  width: "1.4rem",
  height: "1.4rem",
...
function Spot({
  ...
  const [isDragging, setIsDragging] = (0, import_react.useState)(false), [isHovering, setIsHovering] = (0, import_react.useState)(false), x = useMotionValue(round2(bounds.width * (value.x / 100))), y = useMotionValue(round2(bounds.height * (value.y / 100)));
  (0, import_react.useEffect)(() => {
    x.set(round2(bounds.width * (value.x / 100))), y.set(round2(bounds.height * (value.y / 100)));
  }, [x, y, value, bounds]);
  const handleDragEnd = (0, import_react.useCallback)(() => {
    setIsDragging(false);
    const currentX = x.get(), currentY = y.get(), newX = round2(currentX * 100 / bounds.width), newY = round2(currentY * 100 / bounds.height), safeX = Math.max(0, Math.min(100, newX)), safeY = Math.max(0, Math.min(100, newY));
    update2(value._key, safeX, safeY);
  }, [x, y, value, update2, bounds]), handleDragStart = (0, import_react.useCallback)(() => setIsDragging(true), []), handleHoverStart = (0, import_react.useCallback)(() => setIsHovering(true), []), handleHoverEnd = (0, import_react.useCallback)(() => setIsHovering(false), []);
  return !x || !y ? null : (0, import_jsx_runtime.jsx)(
    motion.div,
    {
      drag: true,
      ...
      children: (0, import_jsx_runtime.jsx)(
        Tooltip,
        {
          disabled: isDragging,
          portal: true,
          content: tooltip && typeof tooltip == "function" ? (0, import_react.createElement)(tooltip, { value, renderPreview, schemaType }) : (0, import_jsx_runtime.jsx)(Box, { padding: 2, style: { maxWidth: 200, pointerEvents: "none" }, children: (0, import_jsx_runtime.jsx)(Text, { textOverflow: "ellipsis", children: hotspotDescriptionPath ? get_default(value, hotspotDescriptionPath) : `${value.x}% x ${value.y}%` }) }),
...
function useUnmountEffect(effect) {
  const effectRef = (0, import_react.useRef)(effect);
  effectRef.current = effect, (0, import_react.useEffect)(() => () => effectRef.current(), []);
}
function useDebouncedCallback(callback, deps, delay2, maxWait = 0) {
  const timeout = (0, import_react.useRef)(), waitTimeout = (0, import_react.useRef)(), cb = (0, import_react.useRef)(callback), lastCall = (0, import_react.useRef)(), clear = () => {
  ...
  return useUnmountEffect(clear), (0, import_react.useEffect)(() => {
    cb.current = callback;
  }, deps), (0, import_react.useMemo)(() => {
    const execute = () => {
...
var isBrowser = typeof window < "u" && typeof navigator < "u" && typeof document < "u";
...
function useResizeObserver(target, callback, enabled = true) {
  const ro = enabled && getResizeObserver(), cb = (0, import_react.useRef)(callback);
  cb.current = callback;
  ...
  (0, import_react.useEffect)(() => {
    ...
    return ro.subscribe(_tgt, handler), () => {
      subscribed = false, ro.unsubscribe(_tgt, handler);
    };
  }, [tgt, ro]);
}
...
function ImageHotspotArray(props) {
  var _a;
  const { value, onChange, imageHotspotOptions, schemaType, renderPreview } = props, sanityClient = useClient({ apiVersion: "2022-01-01" }), imageHotspotPathRoot = (0, import_react.useMemo)(() => {
    var _a2;
  ...
  }, [imageHotspotOptions.pathRoot, props.path]), rootObject = useFormValue(imageHotspotPathRoot), resolveInitialValueForType = useResolveInitialValueForType(), resolveInitialValue = (0, import_react.useCallback)(
    async (type) => resolveInitialValueForType(type, {}).then((initialValue) => initialValue).catch(() => {
    }),
    [resolveInitialValueForType]
  ), hotspotImage = (0, import_react.useMemo)(() => imageHotspotOptions.imagePath ? get_default(rootObject, imageHotspotOptions.imagePath) : rootObject, [rootObject, imageHotspotOptions.imagePath]), displayImage = (0, import_react.useMemo)(() => {
    var _a2, _b;
    const builder = (0, import_image_url.default)(sanityClient).dataset((_a2 = sanityClient.config().dataset) != null ? _a2 : ""), urlFor = (source) => builder.image(source);
    ...
    return null;
  }, [hotspotImage, sanityClient]), handleHotspotImageClick = (0, import_react.useCallback)(
    async (event) => {
      ...
      imageHotspotOptions != null && imageHotspotOptions.descriptionPath && (newRow[imageHotspotOptions.descriptionPath] = description), onChange(PatchEvent.from([setIfMissing([]), insert$1([newRow], "after", [-1])]));
    },
    [imageHotspotOptions, onChange, resolveInitialValue, schemaType]
  ), handleHotspotMove = (0, import_react.useCallback)(
    (key, x, y) => {
      onChange(
        PatchEvent.from([
    ...
    [onChange]
  ), hotspotImageRef = (0, import_react.useRef)(null), [imageRect, setImageRect] = (0, import_react.useState)();
  return useResizeObserver(
  ...
  ), (0, import_jsx_runtime.jsxs)(Stack, { space: [2, 2, 3], children: [
    displayImage != null && displayImage.url ? (0, import_jsx_runtime.jsxs)("div", { style: { position: "relative" }, children: [
      imageRect && ((_a = value == null ? void 0 : value.length) != null ? _a : 0) > 0 && (value == null ? void 0 : value.map((spot, index) => (0, import_jsx_runtime.jsx)(
        Spot,
        {
          index,
          value: spot,
      ...
      (0, import_jsx_runtime.jsx)(Card, { __unstable_checkered: true, shadow: 1, children: (0, import_jsx_runtime.jsx)(Flex, { align: "center", justify: "center", children: (0, import_jsx_runtime.jsx)(
        "img",
        {
          ref: hotspotImageRef,
    ...
    ] }) : (0, import_jsx_runtime.jsx)(Feedback, { children: imageHotspotOptions.imagePath ? (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      "No Hotspot image found at path ",
      (0, import_jsx_runtime.jsx)("code", { children: imageHotspotOptions.imagePath })
      ...
      " ",
      (0, import_jsx_runtime.jsx)("code", { children: "options.hotspotImagePath" })
    ] }) }),
    imageHotspotOptions.pathRoot && !VALID_ROOT_PATHS.includes(imageHotspotOptions.pathRoot) && (0, import_jsx_runtime.jsxs)(Feedback, { children: [
...
var imageHotspotArrayPlugin = definePlugin({
...
lodash-es/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=sanity-plugin-hotspot-array.js.map
